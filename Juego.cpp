...
Juego::Juego()
    : g_hWnd(NULL), g_hInst(NULL), g_driverType(D3D_DRIVER_TYPE_NULL), g_featureLevel(D3D_FEATURE_LEVEL_11_0),
    g_pd3dDevice(NULL), g_pImmediateContext(NULL), g_pSwapChain(NULL), g_pRenderTargetView(NULL),
    g_pDepthStencil(NULL), g_pDepthStencilView(NULL), g_pVertexShader(NULL), g_pPixelShader(NULL),
...
HRESULT Juego::InitWindow(HINSTANCE hInstance, int nCmdShow)
{
    // Register class
    WNDCLASSEX wcex;
